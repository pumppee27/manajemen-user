...
<!-- Modal Tambah User -->
<div class="modal" id="tambah_user" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl overflow-auto" >
    <div class="modal-content">
              ...
              <div class="col-6">
                  <div class="row">
                      ...
                      <div class="mb-3 row">
                          ...
                          <div class="col-sm-8">
                              <select class="form-select form-control-sm" aria-label="Default select example" id="level-user" name="level_user">
                                  <option></option>
                      ...
                      <div class="mb-3 row">
                          ...
                          <div class="col-sm-8">
                              <select class="form-select select" aria-label="Default select example" id="uppd_user" name="uppd_id">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary" id="btn-tambah-user">Save changes</button>
      </div>
  </form>
    </div>
  </div>
